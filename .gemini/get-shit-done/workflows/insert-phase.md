...
```bash
INIT=$(node "/Users/glestryc/personal/github_repos/gsd-scratch-work/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/glestryc/personal/github_repos/gsd-scratch-work/.gemini/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
