...
```bash
UI_AUDITOR_MODEL=$(node "/Users/glestryc/personal/github_repos/gsd-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```markdown
Read /Users/glestryc/personal/github_repos/gsd-scratch-work/.claude/agents/gsd-ui-auditor.md for instructions.
...
```bash
node "/Users/glestryc/personal/github_repos/gsd-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
