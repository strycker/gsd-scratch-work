...
- 🔄 **v1.3 — Consolidation, submodule parity & PyPI** — Research **`.planning/research/`** (2026-03-25). **On this roadmap:** phases **28–34** (milestone backlog fully scoped below; **28–30** = shipped).
...
- [ ] **Phase 31: v1.3 — Library workspace & path API (PyPI-safe)** — **PKG-10**
- [ ] **Phase 32: v1.3 — PyPI release engineering & publish story** — **PKG-11**
- [ ] **Phase 33: v1.3 — Root prune (redundancy removal)** — **PRUNE-10**
