...
**Path note (2026-03-26):** File paths below use **`src/trading_crab_lib/`** — the installable package name is **`trading_crab_lib`** (legacy `market_regime` names are retired in live code and onboarding docs).
...
- Files: `src/trading_crab_lib/ingestion/assets.py`
...
- Files: `src/trading_crab_lib/ingestion/multpl.py`, `src/trading_crab_lib/ingestion/fred.py`, `src/trading_crab_lib/ingestion/assets.py`, `src/trading_crab_lib/gmm.py`, `src/trading_crab_lib/spectral.py`, `src/trading_crab_lib/density.py`
...
- Files: `src/trading_crab_lib/checkpoints.py`
...
- Files: `src/trading_crab_lib/config.py`, `src/trading_crab_lib/ingestion/fred.py`, `pipelines/01_ingest.py`
...
- Files: `src/trading_crab_lib/checkpoints.py` (model pickles), `src/trading_crab_lib/ingestion/grok.py` (grok pickle), `src/trading_crab_lib/cluster_comparison.py` (loads pickled RF models)
...
- Files: `src/trading_crab_lib/plotting.py`, `src/trading_crab_lib/runtime.py`
...
- Files: `src/trading_crab_lib/ingestion/multpl.py`, `src/trading_crab_lib/ingestion/fred.py`, `src/trading_crab_lib/ingestion/assets.py`
...
- Files: `src/trading_crab_lib/ingestion/multpl.py`
