...
must_haves:
  truths:
    ...
    - "Phase 13 executed 2026-03-19: five VERIFICATION.md files, REQUIREMENTS §8 + table, 13-VALIDATION.md; CORE-02 closed with test_end_date_null_fallback.py."
    - "2026-03-20: $gsd-validate-phase 13 — 13-VALIDATION.md expanded to full Nyquist template (per-task map, manual-only, audit trail, sign-off)."
  artifacts:
