## Trading-Crab Roadmap — **v1.3 archive** (Phases 28–34)
...
- ✅ **v1.0 — Core pipeline + planning evidence** — Phases 1–16 (shipped 2026-03-20) — [full roadmap](v1.0-ROADMAP.md) · [requirements](v1.0-REQUIREMENTS.md) · [audit](v1.0-MILESTONE-AUDIT.md)
- ✅ **v1.2 — Tactics, triggers & expanded signals** — Phases 17–27 (shipped 2026-03-24) — [full roadmap](v1.2-ROADMAP.md) · [requirements](v1.2-REQUIREMENTS.md) · [audit](v1.2-MILESTONE-AUDIT.md)
- ✅ **v1.3 — Consolidation, submodule parity & PyPI** — Phases 28–34 (shipped 2026-03-26) — [full roadmap](v1.3-ROADMAP.md) · [requirements](v1.3-REQUIREMENTS.md) · [audit](v1.3-MILESTONE-AUDIT.md)
