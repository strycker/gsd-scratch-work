...
| **39** | Confusion matrix | Close CLAUDE visualization gap for classifiers | TMPL-03 | Complete — `plot_regime_confusion_matrix`, `05_confusion_matrix.png`, `tests/unit/test_plot_confusion_matrix.py` (2026-03-26) |
...
### Phase 39 — Confusion matrix *(shipped)*

- **Goal:** Visualize walk-forward CV confusion counts for the current-regime classifier.
- **Deliverables:** `plotting.plot_regime_confusion_matrix`, `run_pipeline.py` step 5 + `pipelines/05_predict.py --plots`; PNG `outputs/plots/05_confusion_matrix.png`; unit test.
- **Maps to:** TMPL-03
...
- [x] **Phase 39** — TMPL-03 (confusion matrix plot + wiring) (completed 2026-03-26)
