...
Plans:
- [x] `.planning/phases/01-data-and-constraints-foundations/01-data-and-constraints-foundations-01-PLAN.md` — ingestion, checkpoints, macro + ETF wiring
- [x] `.planning/phases/01-data-and-constraints-foundations/01-data-and-constraints-foundations-02-PLAN.md` — dual causal / non-causal feature artifacts
- [x] `.planning/phases/01-data-and-constraints-foundations/01-data-and-constraints-foundations-03-PLAN.md` — constraint + pipeline smoke tests <done> (see `01-data-and-constraints-foundations-03-SUMMARY.md`; `pytest` subset green)
